...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=0.9\columnwidth]{design_and_methodology/webpage.PNG}}
...
Seven different feature extraction methods were implemented to see which performed best at classifying the Twitter data:
\begin{itemize}
